...
pub struct Msegmentation<E: Curve = Secp256k1> {
    _curve: PhantomData<E>,
}

impl<E> Msegmentation<E> where E: Curve {
    ...
    pub fn encrypt_segment_k(
        ...
        let segment_k = Self::get_segment_k(secret, segment_size, k);
        let E_k = G * random;
    ...
    pub fn assemble_fe(
        ...
        let seg_sum = segments_2n.iter().enumerate().fold(seg1, |acc, (i, s)| {
            if s.clone() == Scalar::<E>::zero() {
                ...
                let two_to_the_n_shifted_fe: Scalar<E> =
                    Scalar::<E>::from(&two_to_the_n_shifted);
    ...
    pub fn to_encrypted_segments(
        ...
        let x_vec = (0..num_of_segments)
            .map(|i| Self::get_segment_k(secret, segment_size, i as u8))
            .collect::<Vec<Scalar<E>>>();
    ...
    pub fn decrypt_segment(
        ...
        let out_of_limit_fe: Scalar<E> =
            Scalar::<E>::from(&BigInt::from(limit_plus_one));
    ...
    pub fn decrypt(
        ...
        match flag {
            ...
            true => Ok(Self::assemble_fe(&vec_secret_unwrap, segment_size)),
        }
    }
}
